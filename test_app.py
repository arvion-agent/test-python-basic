...
def client():
    ...
    # Seed test data using connection-based execute in a transaction
...
def test_get_items(client):
    """Test the get_items endpoint using the class-based view with connection-based execute"""
...
def test_post_items(client):
    """Test posting to the items endpoint using connection-based execute"""
    ...
    # Verify item was added to database using connection-based execute
...
def test_bulk_create_items(client):
    """Test bulk creation of items using connection-based execute"""
    items = [
    ...
    # Verify items were added using connection-based execute
    with engine.connect() as conn:
...
def test_get_item(client):
    """Test the get_item endpoint which uses connection-based execute"""
...
def test_get_nonexistent_item(client):
    """Test getting a non-existent item using connection-based execute"""
